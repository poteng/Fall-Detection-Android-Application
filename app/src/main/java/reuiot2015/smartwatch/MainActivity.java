...
public class MainActivity extends Activity implements Collector.SampleListener, CollectionStoppedFragment.OnCollectionStartButtonClick, CollectionStartedFragment.OnCollectionStopButtonClick, CollectionStartedFragment.OnDrinkingButtonLinked, ProfileSelectFragment.ProfileSelectionListener {
    ...
    private TextView textViewFallCollect;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewFallCollect = (TextView) findViewById(R.id.textViewFallButton);


        // Try to pass mainActivity to predict
        //prediction objPredict = new prediction(MainActivity.this);
    ...
    public void onBacButtonClick(View v) {
        //additional part for collecting new data
        ...
        {
            flagFallCollect = false;
            Log.d("Testing", "---------------------------------------------------------------------------------------BUTTON CHANGE here");

            textViewFallCollect.setText("NonFall");
        }else{
            flagFallCollect = true;

            Log.d("Testing", "---------------------------------------------------------------------------------------BUTTON CHANGE here2");

            textViewFallCollect.setText("Fall");

  /*          DialogFragment dialog = new DialogTest();
